...
const registry = loadLocators(path.join(__dirname, './homepageHeroPage.locators.json'));

export class HomepageHeroPage {
  constructor(private page: Page) {}

  async navigate(baseUrl: string) {
    await this.page.goto(`${baseUrl}/content/global-atlantic/style-guide/components/homepage-hero.html?wcmmode=disabled`);
