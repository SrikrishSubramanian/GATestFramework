...
const registry = loadLocators(path.join(__dirname, 'ratingsCardPage.locators.json'));

export class RatingsCardPage {
  constructor(private page: Page) {}

  async navigate(baseUrl: string) {
    await this.page.goto(`${baseUrl}/content/global-atlantic/style-guide/components/ratings-card.html?wcmmode=disabled`);
