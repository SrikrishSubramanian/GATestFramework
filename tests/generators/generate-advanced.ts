...
const AVAILABLE_COMPONENTS = [
  ...
  { name: 'headline-block', rootSelector: '.cmp-headline-block' },
  ...
  { name: 'ratings-card', rootSelector: '.cmp-rating-card' },
  { name: 'benefits-table', rootSelector: '.cmp-benefits-table' },
  { name: 'brand-relationship', rootSelector: '.cmp-brand-relationship' },
  { name: 'content-highlight', rootSelector: '.cmp-content-highlight' },
  { name: 'decision-tree', rootSelector: '.cmp-decision-tree' },
  { name: 'detail-hero', rootSelector: '.cmp-detail-hero' },
  { name: 'enhanced-related-content', rootSelector: '.cmp-enhanced-related-content' },
  { name: 'homepage-hero', rootSelector: '.cmp-homepage-hero' },
  { name: 'in-brief', rootSelector: '.cmp-in-brief' },
  { name: 'insights-detail-hero', rootSelector: '.cmp-insights-detail-hero' },
  { name: 'insights-listing', rootSelector: '.cmp-insights-listing' },
  { name: 'login', rootSelector: '.cmp-login' },
  { name: 'product-comparison-card', rootSelector: '.cmp-product-comparison-card' },
  { name: 'product-path-detail-card', rootSelector: '.cmp-product-path-detail-card' },
  { name: 'product-path-summary-card', rootSelector: '.cmp-product-path-summary-card' },
  { name: 'quote', rootSelector: '.cmp-quote' },
  { name: 'section', rootSelector: '.cmp-section' },
