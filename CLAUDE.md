...
## AEM Development Conventions

Tests must validate AEM components against project conventions (HTML/accessibility, CSS/BEM naming, interactive states, author-mode structure) — see the `aem-conventions` skill for the full rule set to use as the basis for convention-compliance test assertions.
